...
const PaystackFunding = () => {
  ...
  const handleProceed = () => {
    ...
    setTimeout(() => {
      ...
      alert('Redirecting to Paystack payment... (Demo: integrate Paystack payment URL/WebView)');
    }, 1000);
  };
    ...
    <div className="relative p-6 md:p-5 lg:p-8 ml-0 lg:ml-[280px] mt-[70px] md:mt-16 min-h-[calc(100vh-70px)] md:min-h-[calc(100vh-4rem)] bg-[var(--bg-primary)]">
      <div className="max-w-xl mx-auto">
        <div className="relative flex items-center justify-center min-h-[2.5rem] mb-6">
          ...
          <h1 className="text-xl font-bold text-[var(--text-primary)]">Paystack (Card Payment)</h1>
        </div>
