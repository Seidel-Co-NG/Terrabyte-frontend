      ...
      <div className="flex items-center gap-4 ml-auto">
        ...
        <Link to="/dashboard/profile">
          <div className="flex items-center gap-3 px-4 py-2 rounded-lg cursor-pointer hover:bg-[var(--bg-hover)] transition-colors">
            <div className="w-9 h-9 rounded-full bg-gradient-to-br from-[var(--accent-primary)] to-[var(--accent-secondary)] flex items-center justify-center font-semibold text-[white] text-sm">
              {initial}
            </div>
            <span className="text-[var(--text-primary)] text-sm font-medium hidden md:inline">{displayName}</span>
          </div>
        </Link>
      </div>
    </header>
