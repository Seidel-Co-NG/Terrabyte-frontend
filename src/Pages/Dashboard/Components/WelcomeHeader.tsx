  ...
  return (
    <div className="w-full mb-6 lg:mb-5 p-6 lg:p-5 md:p-4 bg-gradient-to-br from-[var(--accent-hover)] to-[rgba(124,58,237,0.1)] border border-[var(--accent-hover)] rounded-xl">
      <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-6 lg:gap-8">
        ...
        <div className="flex flex-col items-end lg:items-end w-full lg:w-auto lg:min-w-[150px] gap-1 p-4 lg:py-4 lg:px-6 md:py-3 md:px-4 bg-[var(--accent-hover)] border border-[var(--accent-hover)] rounded-lg">
