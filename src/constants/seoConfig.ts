...
export const SEO_ROUTES: Record<string, SEOConfig> = {
  ...
  "/dashboard/profile/biometric-settings": {
    title: "Biometric Settings",
    description: "Configure fingerprint and face ID for Terrabyte. Secure, fast login.",
    keywords: "biometric, fingerprint, Terrabyte security",
  },
